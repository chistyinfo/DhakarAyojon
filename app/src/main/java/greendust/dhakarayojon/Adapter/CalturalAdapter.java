 ...
 */
public class CalturalAdapter extends RecyclerView.Adapter<CalturalAdapter.ViewHolder> {

    private ItemModel itemModel;
    Context context;

    public CalturalAdapter(ItemModel item) {
        itemModel = item;
    }
...
//            url = (TextView)v.findViewById(R.id.txtUrl);
    ...
    @Override
    public CalturalAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
